...
def Manual_drive(keys):
    ...
    if keys[pygame.K_SPACE] and not speed_mode:
        speed_mode = True
        if input_velocity == 1:
            input_velocity = 2
...
def main():
    ...
    global exit_flag, recording, out_annotated, img_counter, vid_counter,frame,steering_angle, last_voltage_print_time, current_time
